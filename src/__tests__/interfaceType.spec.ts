...
describe('Interfaces', () => {
    ...
    const [pointInterface, personInterface, employeeInterface, userInterface, carInterface, cityInterface, coordinatesInterface, moveInterface, productInterface, vehicleInterface] = interfaces;
    beforeEach(() => {
        jest.clearAllMocks();
    });
    it('should generate typeguard for Point Interface (InterfaceDeclaration with one optional property)', function () {
      ...
      return (
        ...
        expect(removeWhitespace(result)).toEqual(
            removeWhitespace(expectedResult),
        );
    });
    ...
    it('should generate typeguard for Employee Interface (InterfaceDeclaration which extends another InterfaceDeclaration)', function () {
        const result = generateInterfaceTypeGuard([employeeInterface, personInterface]);
