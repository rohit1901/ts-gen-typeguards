import {
    ...
    isTypeLiteralNode,
    isTypeReferenceNode,
    isUnionTypeNode, KeywordSyntaxKind,
    SyntaxKind,
    TypeAliasDeclaration,
    TypeElement
} from "typescript";
import {generateKeywordGuard, generatePropertyGuard, generateUnionTypeGuard,} from "../api";
import {
...
export function generateTypeTypeGuard(
    ...
    value !== null`);
        ...
        typeGuardStrings.push(
            ...generateUnionTypeGuard(type, typeName),
        );
...
function handleIntersectionTypes(
    ...
    return factory.createTypeAliasDeclaration(definition.modifiers, definition.name, definition.typeParameters, factory.createTypeLiteralNode(removeDuplicateTypeElements(members)));
}
