...
import {factory, Identifier, LiteralType, LiteralTypeNode, SyntaxKind, TypeAliasDeclaration} from "typescript";
...
export const setupVariables = () => {
    ...
    const aLiteralType: LiteralTypeNode = factory.createLiteralTypeNode({...factory.createStringLiteral('a'), getText: jest.fn().mockReturnValue('a')});
    ...
    const someType = factory.createTypeAliasDeclaration(
        ...
        factory.createUnionTypeNode([
            aLiteralType,
            factory.createLiteralTypeNode({...factory.createNull(), getText: jest.fn().mockReturnValue(null)}),
