 ...
 */
export function isGenericProperty(property: TypeElement, typeParameterName: string): boolean {
  return isPropertySignature(property) && isTypeReferenceNode(property.type) && typeParameterName === property.type.typeName.getText();
}