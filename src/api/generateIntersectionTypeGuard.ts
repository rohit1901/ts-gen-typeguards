...
export function generateIntersectionTypeGuard(
    ...
    for (const member of type.types) {
        ...
        typeGuard.push(...generateKeywordGuard(member, typeName, isProperty), ...generateTypeReferenceGuard(member, typeName, isProperty), ...generateTypeWithinTypeLiteralTypeGuard(
