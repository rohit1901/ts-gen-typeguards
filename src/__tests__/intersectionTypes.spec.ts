import {
    generateIntersectionTypeGuard, generateTypeGuards
} from '../generator';
...
describe('generateIntersectionTypeGuard', () => {
    ...
    it('should generate typeguard for person', function () {
        ...
        const expectedResult = removeWhitespace(`export function isPerson(value: any): value is Person {
    ...
    it('should generate typeguard for address', function () {
        const expectedResult = removeWhitespace(`export function isAddress(value: any): value is Address {
            if (typeof value !== 'object' || value === null) {
                return false;
            }
    ...
    it('should generate typeguard for point', function () {
        const expectedResult = removeWhitespace(`export function isPoint(value: any): value is Point {
            if (typeof value !== 'object' || value === null) {
                return false;
            }
    ...
    it('should generate typeguard for point2', function () {
        const expectedResult = removeWhitespace(`export function isPoint2(value: any): value is Point2 {
            if (typeof value !== 'object' || value === null) {
                return false;
            }
            if (!value.hasOwnProperty('x') || typeof value.x !== 'number') {
    ...
    it('should generate typeguard for point3', function () {
        const expectedResult = removeWhitespace(`export function isPoint3(value: any): value is Point3 {
          if (typeof value !== 'object' || value === null) {
            return false;
          }
