...
import {LogLevelEnum, PropertyContainer} from "../../input/combinedTypeGuards";
...
describe('Generated Guards', () => {
    ...
    it('should test AddressOptional correctly', () => {
        const addressOptional = {
            street: '456 Elm St', city: 'Townsville', postalCodeOptional: '12345',
        };
    ...
    it('should test ContactOptional correctly', () => {
        const contactOptional = {
            email: 'example@example.com', phone: '123-456-7890', faxOptional: '987-654-3210',
        };
    ...
    it('should test PropertyContainer<T> correctly', () => {
        ...
        expect(guards.isPropertyContainer<string>(propertyContainer, isString)).toBe(true);
        expect(guards.isPropertyContainer<string>(onlyRequired, isString)).toBe(true);
    });
    ...
    it('should test PersonWithOptionalAddressInterface correctly', () => {
        ...
        expect(guards.isPersonWithOptionalAddressInterface(personWithOptionalAddressInterface)).toBe(true);
        expect(guards.isPersonWithOptionalAddressInterface(withoutAddress)).toBe(true);
    })
    ...
    it('should test OptionalContainerOfString correctly', () => {
        ...
        expect(guards.isOptionalContainerOfString(optionalContainerOfString, isString)).toBe(true);
        expect(guards.isOptionalContainerOfString(onlyRequired, isString)).toBe(true);
    });
    ...
    it('should test OptionalContainerOfNumber correctly', () => {
        ...
        expect(guards.isOptionalContainerOfNumber(optionalContainerOfNumber, isNumber)).toBe(true);
        expect(guards.isOptionalContainerOfNumber(onlyRequired, isNumber)).toBe(true);
    });
    ...
    it('should test DirectionContainer<T> correctly', () => {
        ...
        expect(guards.isDirectionContainer(directionContainer, isDirection)).toBe(true);
    });
    ...
    it('should test UpDirectionContainer correctly', () => {
        ...
        expect(guards.isUpDirectionContainer(upDirectionContainer, typeguard)).toBe(true);
    });
    ...
    it('should test DownDirectionContainer correctly', () => {
        ...
        expect(guards.isDownDirectionContainer(downDirectionContainer, typeguard)).toBe(true);
    });
    ...
    it('should test ColoredCircle correctly', () => {
        ...
        const typeguard = (val: any): val is { type: 'circle'; radius: number } => {
            return 'type' in val && val.type === 'circle' && 'radius' in val && typeof val.radius === 'number';
        };
    ...
    it('should test ColoredSquare correctly', () => {
        ...
        const typeguard = (val: any): val is { type: 'square'; sideLength: number } => {
            return 'type' in val && val.type === 'square' && 'sideLength' in val && typeof val.sideLength === 'number';
        };
    ...
    it('should test ColorTypeAliasType correctly', () => {
        expect(guards.isColorTypeAliasType(types.ColorTypeAliasType.Red)).toBe(true);
    })
    // MediaTypeType
